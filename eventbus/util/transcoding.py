...
from eventbus.domain.exceptions import EncoderTypeError
...
class ObjectJSONEncoder(JSONEncoder):
    ...
    def encode_dict(self, o):
        if type(o) == dict:
            ...
            return {"__dict__": {"topic": get_topic(o.__class__), "state": self.encode_dict_state(o)}}
    ...
    def encode_tuple(self, o):
        if type(o) == tuple:
            ...
            return {"__tuple__": {"state": self.encode_object(list(o)), "topic": get_topic(o.__class__)}}
    ...
    def encode_list(self, o):
        if type(o) == list:
            ...
            return {"__list__": {"state": [self.encode_object(i) for i in o], "topic": get_topic(o.__class__)}}
    ...
    def encode_set(self, o):
        if type(o) == set:
            ...
            return {"__set__": {"state": self.encode_iterable(o), "topic": get_topic(o.__class__)}}
    ...
    def encode_frozenset(self, o):
        if type(o) == frozenset:
            ...
            return {"__frozenset__": {"state": self.encode_iterable(o), "topic": get_topic(o.__class__)}}
    ...
    def encode_deque(self, o):
        if type(o) == deque:
            ...
            return {"__deque__": {"state": self.encode_object(list(o)), "topic": get_topic(o.__class__)}}
...
class ObjectJSONDecoder(JSONDecoder):
    def __init__(self, object_hook=None, **kwargs):
        super(ObjectJSONDecoder, self).__init__(object_hook=object_hook or decoder, **kwargs)
